function [IB,JB,GBE,GBC,IC,JC,GCE,GCC,CBE,CBC]=BJT(UBE,UBC,IS,NF,NR,UT,BF,BR,TF,TR,CBE0,CBC0,Uje0,me,ujc0,mc,typ)
%paramjetry funkcji: typ = 1 (NPN) -1 (PNP)
...
%                    uje0, ujc0
%                    me,mc
%funkcja zwraca parametry modelu iteracyjnego
...
IB=typ*IB;
IC=typ*IC;
CBE=(TF*IS/(NF*UT))*dxpo(UBE/(NF*UT))+cpx1am(UBE,CBE0,Uje0,me);
CBC=(TR*IS/(NR*UT))*dxpo(UBC/(NR*UT))+cpx1am(UBC,CBC0,Ujc0,mc);
end